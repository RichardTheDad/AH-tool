...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const baseClasses =
      "w-full rounded-lg border border-white/15 bg-white/5 text-zinc-100 transition placeholder:text-zinc-500 focus:border-ember focus:outline-none focus:ring-2 focus:ring-ember/20";
