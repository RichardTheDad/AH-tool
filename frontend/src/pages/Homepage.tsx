          ...
          <div className="grid items-start gap-6 lg:grid-cols-[0.95fr_1.2fr]">
            ...
            <section className="rounded-2xl border border-orange-400/20 bg-zinc-950/75 p-3 shadow-[0_0_36px_rgba(249,115,22,0.12)] backdrop-blur-xl">
              ...
              <div className="overflow-hidden rounded-xl border border-white/10 bg-zinc-950/80">
                <div className="grid grid-cols-[2.2fr_1fr_1fr_1.2fr_1fr_0.9fr_0.9fr] gap-3 border-b border-white/10 bg-white/[0.02] px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-zinc-400">
            ...
            {steps.map((step, index) => (
              <div key={step.title} className="relative rounded-lg border border-white/10 bg-zinc-900/30 px-3 py-2.5">
                ...
                {index < steps.length - 1 ? (
                  <span className="pointer-events-none absolute -right-8 top-1/2 hidden -translate-y-1/2 text-zinc-500 xl:inline">&gt;</span>
                ) : null}
              </div>
            ))}
          </div>
